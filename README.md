...
Atuo na área de tecnologia com foco em suporte técnico, desenvolvimento de software, análise de sistemas, banco de dados, documentação técnica e infraestrutura.

Tenho interesse em criar soluções eficientes, bem organizadas e documentadas, unindo conhecimento técnico com experiência prática em atendimento, implantação, manutenção e melhoria de sistemas.
...
- Experiência com suporte técnico de software
- Conhecimento em desenvolvimento web
- Vivência com banco de dados e análise de divergências
- Interesse em infraestrutura, redes e automação
- Facilidade em documentação técnica e resolução de problemas
...
### Portfolio 2 - Controle de Chamados Técnicos

Aplicação desenvolvida com Ionic e Angular para controle de chamados técnicos.

Principais recursos:

- Tela de login
- Página inicial
- Cadastro de tarefas/chamados
- Listagem de tarefas
- Controle de status
- Controle de prioridade
- Interface responsiva
- Organização em páginas, serviços e componentes

Repositório:  
[portfolio-2-claretiano](https://github.com/EduardoHenrrykSimonato/portfolio-2-claretiano)

---

### Lanchonete Brasa

Projeto de website para lanchonete, desenvolvido com foco em estruturação de páginas, organização visual e apresentação de produtos.
...
Repositório:  
[Lanchonete-Brasa](https://github.com/EduardoHenrrykSimonato/Lanchonete-Brasa)

---

### Projetos Acadêmicos

Repositórios com atividades, trabalhos e projetos desenvolvidos durante minha formação em tecnologia, aplicando conceitos de programação, desenvolvimento web, banco de dados e documentação.

---

## Informações do Perfil

- GitHub: [EduardoHenrrykSimonato](https://github.com/EduardoHenrrykSimonato)
...
- E-mail: eduardohenrryks@gmail.com
